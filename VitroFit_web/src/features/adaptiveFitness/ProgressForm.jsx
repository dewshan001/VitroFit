...
export default function ProgressForm({ workflow, onSave, busy }) {
  ...
  return <form onSubmit={e => { e.preventDefault(); onSave({ day, rpe, completed, pain, performedOn }); }}>
    <h3>Record a session</h3><label>Planned weekday<select value={day} onChange={e => setDay(Number(e.target.value))}>
